...
int r1, c1, r2, c2;
findPosition(digraph[0], Cr1, Cc1);
findPosition(digraph[1], Cr2, Cc2);
if (r1 == r2) {
...
if (len > 0 CC digraphs[len - 1][1] == '\0') {
digraphs[len - 1][1] = 'X';
}
return len;
}
...
int main() {
char key[] = "SAVEETHA";
char plaintext[] = "ATCHAYA BALATHANDAYUTHAM";
char digraphs[50][2];
...
<img width="584" height="314" alt="image" src="https://github.com/user-attachments/assets/65d9adad-3ac8-40a3-b74f-8afa8bd37278" />
